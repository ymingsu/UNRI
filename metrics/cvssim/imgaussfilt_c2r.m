function B = imgaussfilt_c2r(varargin)
...
if ~isImageIPPFilterType_c2r(class(A))
    TF = false;
    return;
end

tooBig = isImageTooBigForIPPFilter_c2r(A, outSize);
...
supportedImageAttributes = {'nonsparse'};
