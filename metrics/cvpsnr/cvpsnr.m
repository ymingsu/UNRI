function [peaksnr, snr] = cvpsnr(A, ref, peakval,NameValueArgs)
...
arguments
    A {mustBeA(A,{'uint8','uint16','int16','single','double','gpuArray'}),mustBeNonsparse}
    ref {mustBeA(ref,{'uint8','uint16','int16','single','double','gpuArray'}),mustBeNonsparse}
...
if nargout < 2
peaksnr = cvpsnralgo(A, ref, peakval,hasBatchDim,@log10);
else
    [peaksnr,snr] = cvpsnralgo(A, ref, peakval,hasBatchDim,@log10);
